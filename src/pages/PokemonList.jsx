...
import listbg1 from "../assets/Images/Backgrounds/listbg1.jpg";
      ...
      <div className="flex w-full max-w-7xl gap-8">
        ...
        <aside className="bg-white/30 backdrop-blur-md border border-white/30 rounded-2xl shadow-md p-6 w-full max-w-xs flex flex-col gap-6 h-fit">
          ...
          <input
            ...
            className="p-3 border-2 border-white-400 rounded-xl w-full bg-white/10 focus:outline-none focus:ring-2 focus:ring-blue-400 text-lg transition-all duration-200 shadow-md text-black placeholder-gray-400"
            value={search}
            onChange={(e) => {
        ...
        <div className="flex-1">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 w-full bg-white/5 backdrop-blur-md p-4 rounded-2xl shadow-md min-h-[600px] items-start justify-center">
